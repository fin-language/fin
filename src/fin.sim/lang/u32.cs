...
public struct u32: IHasU32
{
    ...
    /// </summary>
    public u32 wrap_lshift(i8 rotate_amount)
    {
        ThrowIfMathModeNotSpecified();
        u32 value;
    ...
    /// Sim exception or Error if shift by negative amount or amount larger than type.
    /// </summary>
    public u32 wrap_rshift(i8 rotate_amount)
    {
        ThrowIfMathModeNotSpecified();
        u32 value;
    ...
    /// Sim exception or Error if shift by negative amount or amount larger than type.
    /// </summary>
    public u32 wrap_lshift(i16 rotate_amount)
    {
        ThrowIfMathModeNotSpecified();
        u32 value;
    ...
    /// Sim exception or Error if shift by negative amount or amount larger than type.
    /// </summary>
    public u32 wrap_rshift(i16 rotate_amount)
    {
        ThrowIfMathModeNotSpecified();
        u32 value;
    ...
    /// Sim exception or Error if shift by negative amount or amount larger than type.
    /// </summary>
    public u32 wrap_lshift(i32 rotate_amount)
    {
        ThrowIfMathModeNotSpecified();
        u32 value;
    ...
    /// Sim exception or Error if shift by negative amount or amount larger than type.
    /// </summary>
    public u32 wrap_rshift(i32 rotate_amount)
    {
        ThrowIfMathModeNotSpecified();
        u32 value;
    ...
    /// Sim exception or Error if shift by negative amount or amount larger than type.
    /// </summary>
    public u32 wrap_lshift(i64 rotate_amount)
    {
        ThrowIfMathModeNotSpecified();
        u32 value;
    ...
    /// Sim exception or Error if shift by negative amount or amount larger than type.
    /// </summary>
    public u32 wrap_rshift(i64 rotate_amount)
    {
        ThrowIfMathModeNotSpecified();
        u32 value;
    ...
    /// Sim exception or Error if shift by negative amount or amount larger than type.
    /// </summary>
    public u32 wrap_lshift(u8 rotate_amount)
    {
        ThrowIfMathModeNotSpecified();
        u32 value;
    ...
    /// Sim exception or Error if shift by negative amount or amount larger than type.
    /// </summary>
    public u32 wrap_rshift(u8 rotate_amount)
    {
        ThrowIfMathModeNotSpecified();
        u32 value;
    ...
    /// Sim exception or Error if shift by negative amount or amount larger than type.
    /// </summary>
    public u32 wrap_lshift(u16 rotate_amount)
    {
        ThrowIfMathModeNotSpecified();
        u32 value;
    ...
    /// Sim exception or Error if shift by negative amount or amount larger than type.
    /// </summary>
    public u32 wrap_rshift(u16 rotate_amount)
    {
        ThrowIfMathModeNotSpecified();
        u32 value;
    ...
    /// Sim exception or Error if shift by negative amount or amount larger than type.
    /// </summary>
    public u32 wrap_lshift(u32 rotate_amount)
    {
        ThrowIfMathModeNotSpecified();
        u32 value;
    ...
    /// Sim exception or Error if shift by negative amount or amount larger than type.
    /// </summary>
    public u32 wrap_rshift(u32 rotate_amount)
    {
        ThrowIfMathModeNotSpecified();
        u32 value;
    ...
    /// Sim exception or Error if shift by negative amount or amount larger than type.
    /// </summary>
    public u32 wrap_lshift(u64 rotate_amount)
    {
        ThrowIfMathModeNotSpecified();
        u32 value;
    ...
    /// Sim exception or Error if shift by negative amount or amount larger than type.
    /// </summary>
    public u32 wrap_rshift(u64 rotate_amount)
    {
        ThrowIfMathModeNotSpecified();
        u32 value;
