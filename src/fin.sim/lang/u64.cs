...
public struct u64: IHasU64
{
    ...
    /// </summary>
    public u64 wrap_lshift(i8 rotate_amount)
    {
        ThrowIfMathModeNotSpecified();
        u64 value;
    ...
    /// Sim exception or Error if shift by negative amount or amount larger than type.
    /// </summary>
    public u64 wrap_rshift(i8 rotate_amount)
    {
        ThrowIfMathModeNotSpecified();
        u64 value;
    ...
    /// Sim exception or Error if shift by negative amount or amount larger than type.
    /// </summary>
    public u64 wrap_lshift(i16 rotate_amount)
    {
        ThrowIfMathModeNotSpecified();
        u64 value;
    ...
    /// Sim exception or Error if shift by negative amount or amount larger than type.
    /// </summary>
    public u64 wrap_rshift(i16 rotate_amount)
    {
        ThrowIfMathModeNotSpecified();
        u64 value;
    ...
    /// Sim exception or Error if shift by negative amount or amount larger than type.
    /// </summary>
    public u64 wrap_lshift(i32 rotate_amount)
    {
        ThrowIfMathModeNotSpecified();
        u64 value;
    ...
    /// Sim exception or Error if shift by negative amount or amount larger than type.
    /// </summary>
    public u64 wrap_rshift(i32 rotate_amount)
    {
        ThrowIfMathModeNotSpecified();
        u64 value;
    ...
    /// Sim exception or Error if shift by negative amount or amount larger than type.
    /// </summary>
    public u64 wrap_lshift(i64 rotate_amount)
    {
        ThrowIfMathModeNotSpecified();
        u64 value;
    ...
    /// Sim exception or Error if shift by negative amount or amount larger than type.
    /// </summary>
    public u64 wrap_rshift(i64 rotate_amount)
    {
        ThrowIfMathModeNotSpecified();
        u64 value;
    ...
    /// Sim exception or Error if shift by negative amount or amount larger than type.
    /// </summary>
    public u64 wrap_lshift(u8 rotate_amount)
    {
        ThrowIfMathModeNotSpecified();
        u64 value;
    ...
    /// Sim exception or Error if shift by negative amount or amount larger than type.
    /// </summary>
    public u64 wrap_rshift(u8 rotate_amount)
    {
        ThrowIfMathModeNotSpecified();
        u64 value;
    ...
    /// Sim exception or Error if shift by negative amount or amount larger than type.
    /// </summary>
    public u64 wrap_lshift(u16 rotate_amount)
    {
        ThrowIfMathModeNotSpecified();
        u64 value;
    ...
    /// Sim exception or Error if shift by negative amount or amount larger than type.
    /// </summary>
    public u64 wrap_rshift(u16 rotate_amount)
    {
        ThrowIfMathModeNotSpecified();
        u64 value;
    ...
    /// Sim exception or Error if shift by negative amount or amount larger than type.
    /// </summary>
    public u64 wrap_lshift(u32 rotate_amount)
    {
        ThrowIfMathModeNotSpecified();
        u64 value;
    ...
    /// Sim exception or Error if shift by negative amount or amount larger than type.
    /// </summary>
    public u64 wrap_rshift(u32 rotate_amount)
    {
        ThrowIfMathModeNotSpecified();
        u64 value;
    ...
    /// Sim exception or Error if shift by negative amount or amount larger than type.
    /// </summary>
    public u64 wrap_lshift(u64 rotate_amount)
    {
        ThrowIfMathModeNotSpecified();
        u64 value;
    ...
    /// Sim exception or Error if shift by negative amount or amount larger than type.
    /// </summary>
    public u64 wrap_rshift(u64 rotate_amount)
    {
        ThrowIfMathModeNotSpecified();
        u64 value;
