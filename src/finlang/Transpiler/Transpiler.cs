...
public class Transpiler
{
    ...
    public string selectClassWhenDebugging = "ExTypeOverride";
    ...
    public void SetupFileHeaders()
    {
        ...
        {
            string msg = "";
            msg += "// AUTOGENERATED FILE. Do not modify this file manually, it will be overwritten.\n"; 
            msg += $"// finlang{MaybeGetVersionInfo()} generated this file for C# `{cls.GetFqn()}` type.\n";
            ...
            if (Options.OutputChecksum)
            {
                ...
                msg += $"// MD5 hash of source file: {md5String}.\n";
            }

            if (Options.OutputTimestamp)
                msg += $"// Generated {DateTime.Now.ToString("yyyy-MM-dd HH:mm:ss")}.\n";
