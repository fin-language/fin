...
extern const hal_ISpi_vtable hal_Spi__hal_ISpi_vtable_imp;

// Up conversion from hal_Spi to hal_ISpi interface
#define M_hal_Spi__to__hal_ISpi(self_arg)    (hal_ISpi){ .obj = self_arg, .obj_vtable = (const hal_ISpi_vtable*)(&hal_Spi__hal_ISpi_vtable_imp.tx_byte) }
