...
// MD5 hash of source file: fa89e5b79c356fa0bae577d4d13b896c.
...
uint8_t hal_SpiMasterBitBang_rx_tx_byte(hal_SpiMasterBitBang * self, uint8_t tx_byte)
{
    ...
    {
        hal_SpiMasterBitBang_rx_tx_bit_lsb(self, ref tx_byte, ref read_byte);
    }

    return read_byte;
}

void hal_SpiMasterBitBang_rx_tx_bit_lsb(hal_SpiMasterBitBang * self, ref uint8_t tx_byte, ref uint8_t read_byte)
{
