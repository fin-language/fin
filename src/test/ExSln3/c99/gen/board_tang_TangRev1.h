...
extern const board_IGeneralBoard_vtable board_tang_TangRev1__board_IGeneralBoard_vtable_imp;

// Up conversion from board_tang_TangRev1 to board_IGeneralBoard interface
#define M_board_tang_TangRev1__to__board_IGeneralBoard(self_arg)    (board_IGeneralBoard){ .obj = self_arg, .obj_vtable = (const board_IGeneralBoard_vtable*)(&board_tang_TangRev1__board_IGeneralBoard_vtable_imp.get_trap_button) }
