...
extern const hal_IDigOut_vtable hal_DigOutInverter__hal_IDigOut_vtable_imp;

// Up conversion from hal_DigOutInverter to hal_IDigOut interface
#define M_hal_DigOutInverter__to__hal_IDigOut(self_arg)    (hal_IDigOut){ .obj = self_arg, .obj_vtable = (const hal_IDigOut_vtable*)(&hal_DigOutInverter__hal_IDigOut_vtable_imp.set_output_state) }
