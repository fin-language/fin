...
// finlang generated this file for C# `hal.DigOutputFromShiftReg` type.
...
extern const hal_IDigOut_vtable hal_DigOutputFromShiftReg__hal_IDigOut_vtable_imp;

// Up conversion from hal_DigOutputFromShiftReg to hal_IDigOut interface
#define M_hal_DigOutputFromShiftReg__to__hal_IDigOut(self_arg)    (hal_IDigOut){ .obj = self_arg, .obj_vtable = (const hal_IDigOut_vtable*)(&hal_DigOutputFromShiftReg__hal_IDigOut_vtable_imp.set_output_state) }
