...
extern const hal_IGpio_vtable mcu_stm32_Stm32Gpio__hal_IGpio_vtable_imp;
...
#define MAA_mcu_stm32_Stm32Gpio__to__hal_IGpio(self_arg)    { .obj = self_arg, .obj_vtable = (const hal_IGpio_vtable*)(&mcu_stm32_Stm32Gpio__hal_IGpio_vtable_imp.read_state) }
// MCL stands for Macro Compound Literal. See https://github.com/fin-language/fin/issues/60 
#define MCL_mcu_stm32_Stm32Gpio__to__hal_IGpio(self_arg)    (hal_IGpio){ .obj = self_arg, .obj_vtable = (const hal_IGpio_vtable*)(&mcu_stm32_Stm32Gpio__hal_IGpio_vtable_imp.read_state) }

// Up conversion from mcu_stm32_Stm32Gpio to hal_IDigInOut interface
// MAA stands for Macro Aggregate Assignment. See https://github.com/fin-language/fin/issues/60 
#define MAA_mcu_stm32_Stm32Gpio__to__hal_IDigInOut(self_arg)    { .obj = self_arg, .obj_vtable = (const hal_IDigInOut_vtable*)(&mcu_stm32_Stm32Gpio__hal_IGpio_vtable_imp.read_state) }
// MCL stands for Macro Compound Literal. See https://github.com/fin-language/fin/issues/60 
#define MCL_mcu_stm32_Stm32Gpio__to__hal_IDigInOut(self_arg)    (hal_IDigInOut){ .obj = self_arg, .obj_vtable = (const hal_IDigInOut_vtable*)(&mcu_stm32_Stm32Gpio__hal_IGpio_vtable_imp.read_state) }

// Up conversion from mcu_stm32_Stm32Gpio to hal_IDigIn interface
// MAA stands for Macro Aggregate Assignment. See https://github.com/fin-language/fin/issues/60 
#define MAA_mcu_stm32_Stm32Gpio__to__hal_IDigIn(self_arg)    { .obj = self_arg, .obj_vtable = (const hal_IDigIn_vtable*)(&mcu_stm32_Stm32Gpio__hal_IGpio_vtable_imp.read_state) }
// MCL stands for Macro Compound Literal. See https://github.com/fin-language/fin/issues/60 
#define MCL_mcu_stm32_Stm32Gpio__to__hal_IDigIn(self_arg)    (hal_IDigIn){ .obj = self_arg, .obj_vtable = (const hal_IDigIn_vtable*)(&mcu_stm32_Stm32Gpio__hal_IGpio_vtable_imp.read_state) }

// Up conversion from mcu_stm32_Stm32Gpio to hal_IDigOut interface
// MAA stands for Macro Aggregate Assignment. See https://github.com/fin-language/fin/issues/60 
#define MAA_mcu_stm32_Stm32Gpio__to__hal_IDigOut(self_arg)    { .obj = self_arg, .obj_vtable = (const hal_IDigOut_vtable*)(&mcu_stm32_Stm32Gpio__hal_IGpio_vtable_imp.set_state) }
// MCL stands for Macro Compound Literal. See https://github.com/fin-language/fin/issues/60 
#define MCL_mcu_stm32_Stm32Gpio__to__hal_IDigOut(self_arg)    (hal_IDigOut){ .obj = self_arg, .obj_vtable = (const hal_IDigOut_vtable*)(&mcu_stm32_Stm32Gpio__hal_IGpio_vtable_imp.set_state) }
